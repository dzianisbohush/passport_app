...
import StatusPage from 'client/pages/status/components';
import { getPasswordsItems } from 'client/pages/home/containers';
import acceptPasswords from 'client/api/acceptPasswords';
import declinePasswords from 'client/api/declinePasswords';
