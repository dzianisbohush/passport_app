...
import Home from 'client/pages/home/components';
import deletePassword from 'client/api/deletePasswordItem';
import getPasswordsByUserEmail from 'client/api/getPasswordsByUserEmail';
import getUsers from 'client/api/getUsers';
import sharePasswords from 'client/api/sharePasswords';
import uploadPasswords from 'client/api/uploadPasswords';
import {
  getPasswordsPending,
  getPasswordsFailure,
  getPasswordsSuccess,
